...
import androidx.compose.material3.CardGroup
...
fun DataCleanupPage(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            contentPadding = contentPadding + androidx.compose.foundation.layout.PaddingValues(8.dp),
            verticalArrangement = Arrangement.spacedBy(16.dp),
        ) {
            item {
                CardGroup(
                    modifier = Modifier.padding(horizontal = 8.dp),
                    title = { Text(stringResource(R.string.data_cleanup_storage_title)) },
                ) {
                    item(
            ...
            item {
                CardGroup(
                    modifier = Modifier.padding(horizontal = 8.dp),
                    title = { Text(stringResource(R.string.data_cleanup_orphan_title)) },
                ) {
                    item(
                        ...
                        trailingContent = {
                            Button(
                                ...
                                enabled = orphanCount != null && orphanCount > 0
                            ) {
            ...
            item {
                CardGroup(
                    modifier = Modifier.padding(horizontal = 8.dp),
                    title = { Text(stringResource(R.string.data_cleanup_days_title)) },
                ) {
                    item(
                        leadingContent = { Icon(HugeIcons.Calendar01, null) },
                        headlineContent = {
